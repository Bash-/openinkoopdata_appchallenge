...
for tender_id in tender_ids:
    ...
    write_dict_to_json_file(qa_pairs, f"{file_path}qa_pairs_tender{tender_id}.json")
    write_dict_to_json_file(results, f"{file_path}results_tender{tender_id}.json")

df_result = pd.DataFrame(all_results)
df_result.to_csv(f"{file_path}results_all.csv", index=False)
