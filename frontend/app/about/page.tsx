      ...
      >
        <div className="relative mx-auto max-w-2xl px-4">
          ...
          <p className="leading-normal text-muted-foreground">
            ...
            Deze webapplicatie probeert hier een antwoord op te geven door het makkelijker te maken voor bedrijven om aanbestedingen van het Rijk te vinden en te begrijpen.
          </p>
          <br></br>
